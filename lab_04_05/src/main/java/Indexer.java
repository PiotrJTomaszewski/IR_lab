...
public class Indexer {
    ...
    private void indexDocuments() {
        ...
        IndexWriter writer;
        try {
            writer = new IndexWriter(FSDirectory.open(Paths.get(Constants.index_dir)), config);
    ...
    private Document getHTMLDocument(String path, int id) {
        ...
        */
        ...
        // ----------------------------------
        String fileContent = Objects.requireNonNull(getTextFromHTMLFile(file));
        document.add(new TextField(Constants.content, fileContent, Field.Store.NO));
        ...
        // ----------------------------------
        // TODO add fields to the document object - Already done
        // ----------------------------------
